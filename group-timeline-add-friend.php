          ...
          <div class="timeline-nav-bar hidden-sm hidden-xs">
            <div class="row">
              ...
              <ul class="list-inline profile-menu">
                  ...
                  <li><a href="group-timeline-friends.php" class='active'>Members</a></li>
                ...
                <h2>Suggested Friends</h2>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="friend-card">
                      <img
                        <?php if($nf['cover']=="cover.png"){ ?>
                        src="php/index/usr/cover.png"
                        <?php }
                        else{ ?>
                        src="php/index/usr/<?php echo md5($nf['email']) ?>/<?php echo $nf['cover'] ?>"
                        <?php }?>
                        alt="profile-cover"
                      ...
                      <div class="card-info">
                        ...
                        <div class="friend-info">
                          ...
                          <button class="pull-right text-green add-remove-friend" id="addf<?php echo $nf['id'] ?>addfriend" type="button" onclick="addFri(<?php echo $nf['id'] ?>,'addfriend')"><?php echo $msg ?></button>

                          <h5>
                            <a href="timeline.html" class="profile-link">
                            <?php echo $nf['firstname']." ".$nf['lastname'] ?>
                            </a>
                          </h5>
                          <p><?php echo $nf['district']; ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
