...
<?php include("php/album/album-photos.php"); ?>
            ...
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu login">
                  <li><a href="group-timeline.html">Timeline</a></li>
                  <li><a href="group-timeline-about.html">Timeline About</a></li>
                  <li><a href="group-timeline-album.html">Timeline Album</a></li>
                  <li><a href="group-timeline-friends.html">Timeline Friends</a></li>
          ...
          <div class="timeline-nav-bar hidden-sm hidden-xs">
            <div class="row">
              ...
              <ul class="list-inline profile-menu">
                  ...
                  <li><a href="group-timeline-album.php" class="active">Album</a></li>
                  <li><a href="group-edit-profile-basic.php">Manage</a></li>
                  <li><a href="group-timeline-about.html">About</a></li>
                </ul>
                <ul class="follow-me list-inline">
                  <li><?php echo $follower ?> Members</li>
                  <li>
                    <a href="group-timeline-add-friend.php" class="add-friend">Add Group</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <ul class="album-photos">
                <?php foreach($albumPic as $pic): ?>
                <li>
                  <div class="img-wrapper" data-toggle="modal" data-target=".<?php echo $pic['id'] ?>">
                    <img src="php/index/usr/<?php requsrinfo("email",$pic['uid']); ?>/<?php echo $pic['file'] ?>" alt="photo" />
                  </div>
                  <div class="modal fade <?php echo $pic['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <h2><?php echo $pic['texts'] ?></h2>
                        <h4><?php echo "Posted on " . date("d-m-Y", $pic['date_time']); echo " at ".date("h:i:sa",$pic['date_time']); ?></h4>
                        <img src="php/index/usr/<?php requsrinfo("email",$pic['uid']); ?>/<?php echo $pic['file'] ?>" alt="photo" />
                      </div>
                    </div>
                  </div>
