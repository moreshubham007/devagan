                ...
                <div class="edit-block">
                  <form name="manage" id="manage-options" class="form-inline" method="POST">
                    <div class="row">
                      <div class="form-group col-xs-12">
                         <div class='people-admin-tab'>
                           <ul>
                             <li class='people-admin'><a href="manage-members.php">Members</a></li>
                             <li class='people-admin activated'><a href="group-admin.php">Admin</a></li>
                           </ul>
                         </div>                                               
                      </div>
                    </div>
                    ...
                    <div class="form-group col-xs-12 members-list">     
                        ...
                        <button class="btn-style invite-frnd">Make Admin</button>
                    </div>
                    ...
                    <div class="form-group col-xs-12 members-list">     
                        ...
                        <div class="admin-frnd">Admin</div>
                    </div>
